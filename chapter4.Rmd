...
From the above pair-wise comparison plot, we can infer that cluster 1 (lower crime rate) is labeled by `red` and cluster 2 (higher crime rate) is labeled by `blue`. 
